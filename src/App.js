...
mapboxgl.accessToken =
  "pk.eyJ1IjoibG9uZG9uYm95MTQ0IiwiYSI6ImNsOWp0MHN5NTA1YTEzdnFkb2lyeWptdDUifQ.ra_Jr8LnsQdkXN-HESSGGQ";
    ...
    if (map.current) {
      ...
      map.current.on("load", function () {
        ...
        function updateMarkers() {
          var newMarkers = {};
          var features = map.current.querySourceFeatures("earthquakes");
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div style={{ height: "100vh" }} className="fuk" ref={mapContainer} />
        <a
          className="App-link"
